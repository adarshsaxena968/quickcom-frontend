        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
          ...
          <div>
            ...
            >
              ...
              {userData?.length == 0 ? <div style={{ marginLeft: 5, fontWeight: 'bold', fontSize: 16 }} onClick={(e) => navigate('/login')}>Sign In</div> : <div style={{ marginLeft: 5, fontWeight: 'bold', fontSize: 16 }}>{userData[0]?.firstname}</div>}
            </IconButton> : <div></div>}
